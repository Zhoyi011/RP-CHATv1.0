      ...
      <div className="flex items-end gap-2">
                  ...
                  {roomPersonas.map(persona => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-400 dark:text-gray-500">#{persona.sameNameNumber || '?'}</p>
                      </div>
                    </button>
                  ))}
                </motion.div>
        ...
        <div className="relative flex-shrink-0 pb-0.5" ref={emojiContainerRef}>
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            whileHover={{ scale: 1.1 }}
            className="w-10 h-10 rounded-full flex items-center justify-center text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <motion.button
          ...
          className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-xs font-medium ${
            hasContent && !isTranslating ? 'text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300' : 'text-gray-300 dark:text-gray-600 cursor-not-allowed'
          }`}
        >

...
const PendingRequests = () => {
  ...
  const getDisplayName = (persona: PendingMember['personaId']) => {
    return persona?.displayName || persona?.name || '未知角色';
  };
          ...
          <div className="space-y-3">
            <div className="bg-blue-50 rounded-xl p-3 mb-2">
              <p className="text-sm text-blue-700">
                共有 <span className="font-bold">{requests.length}</span> 个申请待处理
              </p>
            </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <p className="font-semibold text-gray-800">{getDisplayName(req.personaId)}</p>
          ...
          <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="font-bold text-gray-800">{getDisplayName(selectedRequest.personaId)}</p>
                  <p className="text-sm text-gray-500">{selectedRequest.userId?.username}</p>
                  <p className="text-xs text-gray-400">{selectedRequest.userId?.email}</p>
                </div>
              </div>
